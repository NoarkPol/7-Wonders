...
namespace SevenWondersDuel {
    ...
    class DraftWonderCommand : public IGameCommand {
        std::string wonderId;
    public:
        explicit DraftWonderCommand(std::string id) : wonderId(std::move(id)) {}
    ...
    class BuildCardCommand : public IGameCommand {
        std::string cardId;
    public:
        explicit BuildCardCommand(std::string id) : cardId(std::move(id)) {}
        void execute(GameController& controller) override;
    };
    ...
    class DiscardCardCommand : public IGameCommand {
        std::string cardId;
    public:
        explicit DiscardCardCommand(std::string id) : cardId(std::move(id)) {}
        void execute(GameController& controller) override;
    };
    ...
    class BuildWonderCommand : public IGameCommand {
        ...
        std::string wonderId;
    public:
        BuildWonderCommand(std::string cid, std::string wid) : cardId(std::move(cid)), wonderId(std::move(wid)) {}
        void execute(GameController& controller) override;
    };
    ...
    class SelectProgressTokenCommand : public IGameCommand {
        ProgressToken token;
    public:
        explicit SelectProgressTokenCommand(ProgressToken t) : token(t) {}
        void execute(GameController& controller) override;
    };
    ...
    class DestructionCommand : public IGameCommand {
        std::string targetId;
    public:
        explicit DestructionCommand(std::string tid) : targetId(std::move(tid)) {}
        void execute(GameController& controller) override;
    };
    ...
    class SelectFromDiscardCommand : public IGameCommand {
        std::string cardId;
    public:
        explicit SelectFromDiscardCommand(std::string id) : cardId(std::move(id)) {}
        void execute(GameController& controller) override;
    };
    ...
    public:
        explicit ChooseStartingPlayerCommand(std::string tid) : targetId(std::move(tid)) {}
        void execute(GameController& controller) override;
    };
